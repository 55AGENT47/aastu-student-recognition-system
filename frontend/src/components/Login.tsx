...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <a href="/" className="absolute top-4 left-4 flex items-center space-x-2 text-gray-700 hover:text-blue-600 transition-colors">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="block w-full px-3 py-2 pr-10 border border-gray-300 rounded-md shadow-sm bg-white text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
