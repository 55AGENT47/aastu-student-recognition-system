...
from .routers import auth, students, cameras, logs, stats, face_recognition, registration, images, users, meal_schedules
...
for router in [auth.router, students.router, cameras.router, logs.router, stats.router, face_recognition.router, registration.router, images.router, users.router, meal_schedules.router]:
